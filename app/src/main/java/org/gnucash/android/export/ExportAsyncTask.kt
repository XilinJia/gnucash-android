...
class ExportAsyncTask(
    ...
    private var mExportedFiles: List<String?>? = emptyList<String>()
     ...
     */
    protected override fun doInBackground(vararg params: ExportParams?): Boolean {
    ...
    private val exporter: Exporter
        private get() = when (mExportParams!!.exportFormat) {
            ...
            else -> GncXmlExporter(mExportParams, mDb)
        }
    ...
    private fun moveToTarget() {
        when (mExportParams!!.exportTarget) {
            ...
            else -> throw ExporterException(mExportParams!!, "Invalid target")
        }
    }
    ...
    private fun shareFiles(paths: List<String?>?) {
        ...
        if (defaultEmail != null && defaultEmail.trim { it <= ' ' }.length > 0) shareIntent.putExtra(
            Intent.EXTRA_EMAIL,
    ...
    private fun reportSuccess() {
        ...
        targetLocation = when (mExportParams!!.exportTarget) {
